...
- Recommended docs:
  ...
  - stakeholders/*: stakeholder map, communication plan, and initiative-level politics notes. Use this together with company-level stakeholders (`1-Context/6-company-stakeholders.md`), stakeholder avatars (`1-Context/1.1-Stakeholder-Avatars/`), and organization survival docs (`1-Context/1.2-Organization-Survival/`) when you're pressure-testing "who gets surprised" and "who can block this".
