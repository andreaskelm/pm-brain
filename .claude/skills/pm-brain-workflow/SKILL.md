...
Read and follow [system/skills/pm-brain-workflow/SKILL.md](../../../system/skills/pm-brain-workflow/SKILL.md). That file is the source of truth — this wrapper exists only so Claude Code discovers the skill natively. Do not duplicate content here.
