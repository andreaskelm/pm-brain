# 5-Growth/2-Growth-Portfolio — Growth Portfolio
...
**To check or change mode:** See `5-Growth/README.md`
...
**Product Judgment Test:** Your [Overall Brier trend](../3-Product-Judgment-Test/dashboard.md) is evidence of calibration—reference it in your journey and in [3-metrics-dashboard.md](3-metrics-dashboard.md).
...
**Evidence:**
- Weekly reflections: 5-Growth/1-Learning-Log/2026-Q1/
