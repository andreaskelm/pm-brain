...
2. **Scale:** What if 10x, 100x, 1000— users?
...
**If you want persistent product coaching** across multiple conversations in ChatGPT or Claude, use the [Product Coach setup template](7-product-coach-setup.md). This sets up a persistent persona that provides the same workflow as Cursor's product_sense state (braindump → pattern recognition → framework selection → execution).
...
**Setup:** Copy the template from `7-product-coach-setup.md` into a ChatGPT or Claude Project.
...
- **Meta-thinking (modes, bias, assumption):** [6-meta-thinking-for-product-sense.md](../../2-Methods/1-Foundations/1-Mental-Models/6-Product-Sense-Development/6-meta-thinking-for-product-sense.md)
- **Confidence calibration / forecast log:** [5-Growth/3-Product-Judgment-Test](../3-Product-Judgment-Test/)
- **Golden rule:** [system/coaching/braindump.md](../../system/coaching/braindump.md)
- **Product Coach setup** (persistent persona for external AI): [7-product-coach-setup.md](7-product-coach-setup.md)
