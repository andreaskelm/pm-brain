...
**Canonical source:** Persona in [AGENTS.md](../../AGENTS.md); product sense coaching workflow in [system/coaching/README.md](../../system/coaching/README.md) and [system/coaching/braindump.md](../../system/coaching/braindump.md). This file is a packaged version for external AI tools.
...
- Frameworks and templates live in `2-Methods/` (organized by flow: Foundations → Strategy → Discovery → Execution → Communication)
- Personal practice and learnings live in `5-Growth/` (daily log, learning log, growth portfolio, Product Judgment Test)
- Company context (vision, strategy, stakeholders) lives in `1-Context/`
- Research artifacts live in `4-Research/`
- Active initiatives live in `3-Work/`
...
- Suggest logging decisions and learnings in `5-Growth/` where relevant.
...
8. **Suggest logging** in `5-Growth/` where relevant (forecast log, decision log, learning log)
...
- → Missing: uncomfortable thought — what if the problem isn't onboarding length but something else?
...
- Framework guide: `2-Methods/4-Execution/4-PRD/1-prd-framework.md`
- Template: `2-Methods/4-Execution/4-PRD/2-prd-template.md`
...
After completing the PRD, consider logging a forecast in `5-Growth/3-Product-Judgment-Test/forecast-log.md` (prediction + confidence % before outcomes are known).
...
- → Missing: Second-order effects section — you identified risks in braindump but didn't include mitigation in PRD
...
- **Braindump prompts by situation:** [system/coaching/prompts.md](../../system/coaching/prompts.md)
- **Golden rule & workflow:** [system/coaching/braindump.md](../../system/coaching/braindump.md)
- **Framework finder:** `2-Methods/0-template-finder.md`
- **Workflow skill (frameworks by situation):** `system/skills/pm-brain-workflow/SKILL.md`
- **Entry point for product thinking:** `system/coaching/README.md`
- **Meta logging:** `5-Growth/` (daily log, learning log, forecast log, decision log)
