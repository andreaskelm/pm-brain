# 5-Growth/3-Product-Judgment-Test — Product Judgment Test
...
**Confidence-based rules:** See [system/coaching/braindump.md](../../system/coaching/braindump.md) (Confidence-Based Decision Rules) for when to decide now vs. gather more info vs. double-check with others. Use reversibility + confidence level to choose.
...
- **Learning log:** In your [monthly synthesis](../1-Learning-Log/README.md), review your Product Judgment Test dashboard and note trend vs last month.
- **Growth portfolio:** Summarize your Overall Brier trend in [3-metrics-dashboard.md](../2-Growth-Portfolio/3-metrics-dashboard.md) and [1-product-sense-journey.md](../2-Growth-Portfolio/1-product-sense-journey.md) as evidence of calibration.
...
- **5-Growth overview:** See [5-Growth/README.md](../README.md) for how this fits into your minimal workflow (e.g. before shipping: log forecast; monthly: resolve closed bets, update dashboard, review in monthly synthesis).
