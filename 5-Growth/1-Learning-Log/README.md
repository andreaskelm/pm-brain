# 5-Growth/1-Learning-Log — Learning Log
...
Weekly: [`5-Growth/4-Coaching-Templates/3-weekly-reflection-template.md`](../4-Coaching-Templates/3-weekly-reflection-template.md)  
Monthly: [`5-Growth/4-Coaching-Templates/4-monthly-synthesis-template.md`](../4-Coaching-Templates/4-monthly-synthesis-template.md)
...
```bash
   cp ../4-Coaching-Templates/3-weekly-reflection-template.md 2026-Q1/week-04.md
   ```
 Or from repo root: `cp 5-Growth/4-Coaching-Templates/3-weekly-reflection-template.md 5-Growth/1-Learning-Log/2026-Q1/week-04.md`
...
```bash
   cp ../4-Coaching-Templates/4-monthly-synthesis-template.md 2026-Q1/monthly-jan.md
   ```
 Or from repo root: `cp 5-Growth/4-Coaching-Templates/4-monthly-synthesis-template.md 5-Growth/1-Learning-Log/2026-Q1/monthly-jan.md`
...
3. **Fill it out:**
 ...
 - **Product Judgment Test:** Review your [Product Judgment Test](../3-Product-Judgment-Test/dashboard.md) dashboard and note trend vs last month (Overall Brier, calibration).

4. **Update related files:**
 - Self-assessment (`../self-assessment-2026-Q1.md`, if you create one)
 - Growth portfolio (`../2-Growth-Portfolio/`)
 - Product Judgment Test dashboard (`../3-Product-Judgment-Test/dashboard.md`) — resolve closed bets, update Overall Brier

5. **Commit:**
```bash
   git add 2026-Q1/ ../2-Growth-Portfolio/
...
**To check or change your mode:** See [5-Growth/README.md](../README.md) and [docs/setup.md](../../docs/setup.md) → [Step 3](../../docs/setup.md#step-3-choose-public--private--team-mode).
...
- **Weekly template:** [`5-Growth/4-Coaching-Templates/3-weekly-reflection-template.md`](../4-Coaching-Templates/3-weekly-reflection-template.md)
- **Monthly template:** [`5-Growth/4-Coaching-Templates/4-monthly-synthesis-template.md`](../4-Coaching-Templates/4-monthly-synthesis-template.md)
- **Your daily log:** `../1-daily-log-YYYY-QX.md`
- **Self-assessment:** `../self-assessment-YYYY-QX.md` (if you choose to keep one here)
- **Growth portfolio:** `../2-Growth-Portfolio/`
- **Product Sense entry point:** [README.md](../../system/coaching/README.md) — braindump before structure
