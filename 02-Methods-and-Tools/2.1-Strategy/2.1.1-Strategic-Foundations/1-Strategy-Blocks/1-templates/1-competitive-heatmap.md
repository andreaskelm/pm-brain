# Competitive & Comparables Analysis
...
| **Pricing/Value** | High | 🟢 4 | 🟡 3 | 🟢 4 | 🔴 2 | Us: Competitive pricing. A: Premium pricing. B: Low cost leader. X: Expensive for value. |
| **Customer Support** | Medium | 🟡 3 | 🟢 4 | 🟡 3 | 🟢 4 | Us: Standard support. A: Excellent support team. B: Self-service only. X: White-glove service. |
| **Integration Ecosystem** | Medium | 🔴 2 | 🟢 4 | 🟡 3 | 🟡 3 | Us: Limited integrations. A: Extensive API & partnerships. B: Basic integrations. X: Good third-party support. |

**Scoring Scale:**
- 🟢 4-5: Strong advantage or excellent execution
- 🟡 2-3: Adequate or competitive parity  
- 🔴 1: Weak or significant disadvantage
...
#### Feature Deconstruct Examples

**Competitor A - Advanced Analytics Dashboard:**
- **What it does:** Real-time data visualization with custom report builder
- **Why it matters:** Addresses power user need for data insights
- **Our gap:** We show basic metrics but no customization
- **Strategic consideration:** High-value feature for customer retention

**Comparable X - Onboarding Experience:**
- **What it does:** Interactive tutorial with progressive disclosure
- **Why it matters:** Reduces time-to-value for new users
- **Our approach:** Static help documentation
- **Strategic consideration:** Could improve our activation metrics
...
| **Comparable X** | "The future of [adjacent category]" | Early adopters + Enterprise | Innovation leadership |
...
**User Sources:**
- [ ] Customer interviews mentioning competitors
- [ ] Sales team feedback on lost deals
- [ ] Support team insights on churn reasons
- [ ] Online reviews and comparison sites
- [ ] Industry analyst reports
- [ ] Conference conversations and networking

**Systematic Monitoring:**
- [ ] Set up Google Alerts for competitor names + "funding," "launch," "hire"
- [ ] Follow competitor executives on LinkedIn/Twitter
- [ ] Subscribe to competitor newsletters and blogs
- [ ] Join relevant industry Slack communities
