...
2. Point to:
   - `2-Methods/5-Communication/7-Stakeholder-Management/1-stakeholder-management-framework.md`
...
2. Use:
   - `2-Methods/5-Communication/3-One-Pagers/1-one-pager-framework.md`
...
2. Use:
   - `2-Methods/5-Communication/6-Saying-No/1-saying-no-framework.md`
3. Help them:
...
2. Use:
   - `2-Methods/5-Communication/5-Escalation/1-escalation-framework.md`
   - or `2-Methods/5-Communication/4-Crisis-Management/1-crisis-management-framework.md`
3. Help outline:
...
2. **Connect to upstream thinking**
   - Where relevant, bring in artifacts from `2-Methods/2-Strategy/` or `2-Methods/3-Discovery/` so communication is grounded in real strategy and evidence.
