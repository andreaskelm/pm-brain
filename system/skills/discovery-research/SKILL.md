...
3. Then guide to:
   - Problem/Solution separation:
     - `2-Methods/3-Discovery/6-Problem-Solution-Space/1-problem-solution-space-framework.md`
   - Opportunity evaluation:
     - `2-Methods/3-Discovery/4-Opportunity-Assessment/1-opportunity-assessment-framework.md`
...
2. Point to:
   - `2-Methods/3-Discovery/1-Research-Interviews/1-interview-guide.md`
   - `2-Methods/3-Discovery/2-Continuous-Discovery-Habits/README.md` and the snapshot/synthesis steps.
3. Help them:
...
2. Point to:
   - `2-Methods/3-Discovery/8-Product-Market-Fit/1-pmf-framework.md`
3. Decide together:
...
2. Point to:
   - `2-Methods/3-Discovery/7-Segmentation/README.md` and `1-segmentation-framework.md`
3. Remind: Segments = strategy (what to build); personas = execution (create personas for priority segments via 5-Personas).

## Response guidelines

1. **Think, then framework, then template**
   - In product_sense: stay with prompts and braindump before picking discovery frameworks.
   - Use prompts from `system/coaching/prompts.md` for discovery scenarios.
2. **Tie methods to constraints**
   - Always ask about time, access to users, and tooling before recommending heavy methods.
3. **Be specific**
   - Point to exact files: e.g., “From `2-Methods/3-Discovery/4-Opportunity-Assessment/1-opportunity-assessment-framework.md`…”
4. **Connect the dots**
