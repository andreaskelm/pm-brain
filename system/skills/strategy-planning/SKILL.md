...
2. Use:
   - `2-Methods/2-Strategy/1-Strategic-Foundations/README.md`
   - And, if helpful, a specific framework like:
     - `1-Strategic-Foundations/2-Good-Strategy-Bad-Strategy/1-good-strategy-bad-strategy-framework.md`
     - `1-Strategic-Foundations/3-Playing-To-Win/1-playing-to-win-framework.md`
...
1. Clarify:
   ...
   - **Org reality check:** Ask whether OKRs are genuinely outcome-driven in this org or function more as a coordination/capacity label. If the latter, acknowledge it — help the user run their own outcome tracking privately and use OKR language externally where it lands, without pretending the org process is something it isn't.
2. Point to:
   - `2-Methods/2-Strategy/2-Strategic-Execution/1-OKR/1-okr-framework.md`
3. Then:
   - In **execution_mode**, use `2-Methods/2-Strategy/2-Strategic-Execution/1-OKR/2-okr-template.md` to structure objectives and key results.
   - Use `2-Methods/2-Strategy/2-Strategic-Execution/1-OKR/3-okr-evaluation.md` for a quick quality check before sharing.
...
2. Point to:
   - `2-Methods/2-Strategy/2-Strategic-Execution/2-Roadmap/1-roadmap-framework.md`
3. Help choose:
   - A simple starting format (now/next/later, or quarters with themes).
   - Then use `2-Methods/2-Strategy/2-Strategic-Execution/2-Roadmap/2-roadmap-template.md` and `2-Methods/2-Strategy/2-Strategic-Execution/2-Roadmap/3-roadmap-evaluation.md` as needed.
...
2. Use:
   - `2-Methods/2-Strategy/2-Strategic-Execution/4-Prioritization/1-decision-tree.md` to pick an approach.
...
2. **Match framework to situation**
   - Use [When to Use Which](../../../2-Methods/2-Strategy/1-Strategic-Foundations/README.md#when-to-use-which) in Strategic Foundations where helpful.
3. **Anchor to company context**
   - When relevant, wake:
     - `1-Context/2-company-strategy.md`
     - `1-Context/5-company-roadmap.md`
