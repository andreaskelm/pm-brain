...
> **Related 2-Methods**: See persona and segmentation methods in `../2-Methods/4-Execution/5-Personas/` and related discovery methods in `../2-Methods/3-Discovery/` for guidance on defining customer segments and personas. 
