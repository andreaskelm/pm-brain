...
> **Related 2-Methods**: See discovery methods in `../2-Methods/3-Discovery/` including opportunity assessment (`4-Opportunity-Assessment/`) and validation methods (`5-Idea-Validation/`).
...
> **Related 2-Methods**: See PRD templates in `../2-Methods/4-Execution/4-PRD/` and the overview in `../2-Methods/README.md`.
...
> **Related 2-Methods**: See `../2-Methods/README.md` for the overall methods overview and `../2-Methods/4-Execution/4-PRD/` for product requirements documentation. 
