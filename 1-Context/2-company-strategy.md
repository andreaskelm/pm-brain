...
- Framework and guides: see strategy methods in `../2-Methods/2-Strategy/1-Strategic-Foundations/`
...
> **Next Steps:** Once strategy is defined, operationalize by mapping strategic priorities to OKRs and seeding your roadmap with supporting initiatives. See OKR and roadmap methods in `../2-Methods/2-Strategy/2-Strategic-Execution/1-OKR/` and `../2-Methods/2-Strategy/2-Strategic-Execution/2-Roadmap/`, and `./5-company-roadmap.md` for next steps. 
