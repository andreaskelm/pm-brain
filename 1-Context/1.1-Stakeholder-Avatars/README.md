...
- **When creating a new avatar:** After running the 8-Stakeholder-Avatars quiz, create a new file here with the naming convention below (e.g. `3-sam-design-lead.md`) and paste the filled structure from 8-Stakeholder-Avatars's [2-avatar-template.md](../../2-Methods/5-Communication/8-Stakeholder-Avatars/2-avatar-template.md).
...
1. **Run the quiz** in [8-Stakeholder-Avatars](../../2-Methods/5-Communication/8-Stakeholder-Avatars/README.md) (guided questions per person).
...
3. **Paste the template** from 8-Stakeholder-Avatars's [2-avatar-template.md](../../2-Methods/5-Communication/8-Stakeholder-Avatars/2-avatar-template.md) and fill it with the answers from the quiz.
...
- **Setup method (guided quiz):** [2-Methods/5-Communication/8-Stakeholder-Avatars/](../../2-Methods/5-Communication/8-Stakeholder-Avatars/README.md)
- **Stakeholder directory (organization list):** [6-company-stakeholders.md](../6-company-stakeholders.md)
- **Company context setup:** [docs/setup.md](../../docs/setup.md) → Step 4: Customize (Stakeholder Avatars)
