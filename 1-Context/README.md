...
- Based on my answers, propose 1–2 starting documents under `1-Context/` to work on next:
 - 1-company-vision.md
...
- Suggest which related methods in `2-Methods/` I should use next (e.g. Product Strategy, OKR, Roadmap, Personas).

3) At the end of each pass:
- Summarize the updated company context in 3–5 bullets.
- Propose the next 1–2 `1-Context` documents to refine, and which `2-Methods` frameworks to use alongside them.
