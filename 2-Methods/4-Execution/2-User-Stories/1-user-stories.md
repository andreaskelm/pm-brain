...
**Use prompts from:** [system/coaching/prompts.md](../../../system/coaching/prompts.md) → [Before Writing a PRD](../../../system/coaching/prompts.md#before-writing-a-prd) (user understanding and problem clarity).
