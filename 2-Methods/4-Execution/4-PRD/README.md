...
**Strategic Context:**
- **Strategy (2-strategy/)**: Strategic Foundations sets strategic direction (done first, informs everything); OKR Framework operationalizes strategy into measurable outcomes; Roadmap Framework plans execution timeline
- **Communication (5-communication/)**: Newsletter communicates progress
...
**Use prompts from:** [`../../../system/coaching/prompts.md`](../../../system/coaching/prompts.md) → "Before Writing a PRD" section.
...
## Links
- Strategy: `../../2-Strategy/README.md` (Strategic Foundations, OKR Framework)
- Discovery: `../../3-Discovery/README.md` (Jobs To Be Done, Opportunity Assessment, Idea Validation)
