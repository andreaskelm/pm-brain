...
**Use prompts from:** [system/coaching/prompts.md](../../../system/coaching/prompts.md) → [Before Making a Prioritization Decision](../../../system/coaching/prompts.md#before-making-a-prioritization-decision). Quick start: What's in your backlog → What should be priorities → What assumptions about value and effort → What biases → **See prompts file for full list.**
...
+- Is it an improvement or tech debt?
 ...
 (Plot on 22, qualitative assessment)
...
- RICE/ICE Scoring: `../../2-Strategy/2-Strategic-Execution/4-Prioritization/1-RICE-ICE/1-RICE-ICE-scoring-framework.md`
- Value/Effort Matrix: `../../2-Strategy/2-Strategic-Execution/4-Prioritization/2-Value-Effort-Matrix/README.md`
- MoSCoW: `../../2-Strategy/2-Strategic-Execution/4-Prioritization/3-MoSCoW/README.md`
- Kano Model: `../../2-Strategy/2-Strategic-Execution/4-Prioritization/4-Kano-Model/README.md`

### Related Frameworks
- Strategy: `../../2-Strategy/README.md` (OKR Framework defines outcomes to optimize for, Roadmap shows public view of top priorities)
- PRD Framework: `../4-PRD/README.md` (detailed specs for top items)
- Discovery: `../../3-Discovery/README.md` (Opportunity Assessment)

### Mental Models
- Foundations: `../../1-Foundations/README.md` (Mental Models: Outcome vs Output, Feature Factory, Opportunity Cost)

### Company Context
- Product Strategy: `../../../1-Context/1-company-vision.md`
- Current OKRs: `../../../1-Context/2-company-strategy.md`
