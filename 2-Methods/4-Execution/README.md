...
**Use the prompts:** [system/coaching/prompts.md](../../system/coaching/prompts.md) — "Before Writing a PRD / Feature" (and situation-specific red flags).  
...
- `1-Daily-Execution-And-Rituals/` — Daily/weekly routines, context switching, common scenarios. **Use when:** Setting up your PM operating system, feeling overwhelmed, managing multiple initiatives.

- `2-User-Stories/` — Writing user stories with INVEST criteria. **Use when:** Breaking down features into development tasks, planning sprints, communicating requirements.

- `3-Backlog-Prioritization/` — Systematic backlog prioritization using RICE, ICE, Value/Effort, Severity-Frequency. **Use when:** Sprint planning, quarterly planning, stakeholder negotiations, continuous refinement.

- `4-PRD/` — Product Requirements Documents. **Use when:** After solution validation, for initiatives requiring >2 weeks effort, when cross-functional alignment is critical.

- `5-Personas/` — HEART and JOBS personas. **Use when:** Understanding user segments, making decisions when you can't talk to every user, aligning teams around user understanding.

- `6-Metrics/` — Distinguishing meaningful metrics from vanity metrics. **Use when:** Setting up measurement framework, defining success metrics, quarterly metric audits.
...
| Situation | Go to | Why |
|-----------|-------|-----|
| Setting up daily/weekly routines | `1-Daily-Execution-And-Rituals/` | Provides structured approach to PM execution |
| Breaking features into stories | `2-User-Stories/` | INVEST criteria and splitting patterns |
| Prioritizing backlog items | `3-Backlog-Prioritization/` | Systematic scoring and stack ranking |
| Writing requirements | `4-PRD/` | Comprehensive requirements documentation |
...
- **Product sense (braindump first):** [README.md](../../system/coaching/README.md) — entry point for product thinking; use before PRDs/templates
- **Foundations (../1-Foundations/README.md):** Mental Models (Outcome vs Output, Feature Factory), Self-Reflection, and Bias awareness support all execution work
