...
**Use prompts from:** [system/coaching/prompts.md](../../../system/coaching/prompts.md) → [Generic Step 0 (any framework)](../../../system/coaching/prompts.md#generic-step-0-any-framework). Quick start: What outcomes → What metrics feel meaningful → What assumptions about what to measure → What biases might affect your metric choices → **See prompts file for full list.**
...
- Strategy: `../../2-Strategy/README.md` (North Star, OKRs, Roadmap)
