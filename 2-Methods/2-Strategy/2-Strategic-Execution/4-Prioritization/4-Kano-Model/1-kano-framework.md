...
**Use prompts from:** [system/coaching/prompts.md](../../../../../system/coaching/prompts.md) → [Before Making a Prioritization Decision](../../../../../system/coaching/prompts.md#before-making-a-prioritization-decision). Quick start: What features → Which feel table stakes vs. game-changers → What assumptions about customer expectations → What biases → **See prompts file for full list.**
