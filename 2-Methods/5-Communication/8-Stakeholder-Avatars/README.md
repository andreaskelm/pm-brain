...
- Output: Guided quiz → write/update [1-Context/1.1-Stakeholder-Avatars/](../../../1-Context/1.1-Stakeholder-Avatars/README.md) (one file per avatar: N-name-role.md; see that folder's README for naming)
...
3. **Create one file per person** — In [1-Context/1.1-Stakeholder-Avatars/](../../../1-Context/1.1-Stakeholder-Avatars/README.md), create `N-name-role.md` (e.g. `1-jane-manager.md`). Use the structure in `2-avatar-template.md` and fill from the quiz answers.
