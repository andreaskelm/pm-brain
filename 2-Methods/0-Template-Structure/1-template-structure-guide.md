...
**Example Frameworks:**
- Strategy Blocks Quickstart (`2-strategy/1-Strategic-Foundations/1-Strategy-Blocks/2-quickstart.md`)
...
- North Star Framework (`2-strategy/2-Strategic-Execution/3-North-Star/1-north-star-framework.md`)
...
**Example Frameworks:**
- OKR Evaluation (`3-[framework-name]-evaluation.md`)
- Roadmap Evaluation (`3-[framework-name]-evaluation.md`)
...
**Example:** Strategy Blocks Full Guide (`2-strategy/1-Strategic-Foundations/1-Strategy-Blocks/1-full-guide.md`)
...
- Use **Initiative README Template** for `3-Work/4.x-*` folders
