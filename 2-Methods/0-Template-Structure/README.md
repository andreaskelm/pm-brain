...
- **[Initiative README Template](7-readme-template-initiative.md)** - For initiative folders under `3-Work/`
...
- Strategy Blocks (`2-strategy/1-Strategic-Foundations/1-Strategy-Blocks/2-quickstart.md`)

**Frameworks using Full Framework:**
- OKR Framework (`2-strategy/2-Strategic-Execution/1-OKR/1-okr-framework.md`)
- MoSCoW Prioritization (`2-strategy/2-Strategic-Execution/4-Prioritization/3-MoSCoW/1-moscow-prioritization-framework.md`)

**Frameworks using Evaluation:**
- OKR Evaluation (`../2-Strategy/2-Strategic-Execution/1-OKR/3-okr-evaluation.md`)
- Roadmap Evaluation (`../2-Strategy/2-Strategic-Execution/2-Roadmap/3-roadmap-evaluation.md`)

**Playbook Variants (Special Case):**
- Strategy Blocks Full Guide (`2-strategy/1-Strategic-Foundations/1-Strategy-Blocks/1-full-guide.md`) - Detailed process playbook with week-by-week activities, roles, and deliverables
...
- `3-[framework-name]-evaluation.md` - Evaluation framework (if applicable); when stuck in braindump use `system/coaching/evaluation.md`
...
- Main 2-Methods README: `../README.md`
- Guidelines: `../../docs/principles.md`
