...
**Braindump first:** See [braindump.md](../../../system/coaching/braindump.md) for the golden rule.
...
### 4. Availability Heuristic → HIGH RISK
...
|--------------------------|---------------------------------|-----------------------------|----------|------------------------------|
|**Confirmation Bias** |Seeking confirming evidence |Only interviewing fans |→ Critical|Seek disconfirming evidence |
|**Anchoring Bias** |Over-relying on first info |First price sticks |→ Critical|Multiple independent estimates|
|**Sunk Cost Fallacy** |Continuing due to past investment|“We’ve spent 6 months” |→ Critical|“Would we start this today?” |
