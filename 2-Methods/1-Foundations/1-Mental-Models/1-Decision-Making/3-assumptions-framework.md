...
## What It Is
A diagnostic for understanding the root cause of product disagreements by recognizing that when two people disagree about product strategy, they have different assumptions. The framework shifts focus from arguing solutions to aligning on underlying beliefs.

## How to Think With It
When disagreement occurs, pause solution discussion and ask "What assumptions lead each person to their preferred approach?" Map differences in beliefs about users, market, or technical constraints, then align or validate assumptions through data, research, or testing before revisiting solutions.
...
## When to Apply
- When teams disagree about product strategy or direction
- When top-down strategy conflicts with bottom-up proposals
- When stakeholders seem to be talking past each other
- Before building roadmaps to ensure shared foundation

## PM Example
PM wants to build feature X, engineer wants feature Y. Instead of arguing features, ask: "What assumptions lead you to prefer X?" PM assumes users need quick wins; engineer assumes users need long-term value. Once assumptions are surfaced, you can validate which assumption is correct and align on the solution.

## Combines With
- Alignment Check (`../5-Team-Dynamics/1-alignment-check.md`)
- Discovery: `../../../3-Discovery/README.md` (Opportunity Assessment, Research Interviews)
