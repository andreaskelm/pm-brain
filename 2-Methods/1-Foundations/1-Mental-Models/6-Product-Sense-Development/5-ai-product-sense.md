...
Use this when you're designing or evaluating AI-powered features. Braindump first with the [For AI Product Decisions](../../../../system/coaching/prompts.md#for-ai-product-decisions) section of the [prompts file](../../../../system/coaching/prompts.md#for-ai-product-decisions); use this doc for deeper patterns and tradeoffs.
...
**Product sense:** Safety and trust are product requirements for AI, not afterthoughts. Braindump them in the [Safety & Ethics](../../../../system/coaching/prompts.md#safety--ethics) section of the [prompts file](../../../../system/coaching/prompts.md#safety--ethics).
