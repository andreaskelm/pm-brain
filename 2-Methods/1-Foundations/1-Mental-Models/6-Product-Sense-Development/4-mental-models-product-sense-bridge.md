...
Product sense isn't magic—it's the disciplined application of mental models to product decisions. This doc bridges [1-Decision-Making](../1-Decision-Making/) and [2-Product-Thinking](../2-Product-Thinking/) to the braindump prompts in [system/coaching/prompts.md](../../../../system/coaching/prompts.md) and the golden rule in [braindump.md](../../../../system/coaching/braindump.md).
...
- **One-way / two-way:** JUDGE-3 (Fast Prioritization Drill), [evaluation.md](../../../../system/coaching/evaluation.md)
