...
3. **Third:** Execute in `3-Work/` (ongoing)
   - Build the thing
   - Ship it
   - Learn from outcomes
...
2. Then: Use `2-Methods/4-Execution/4-PRD/2-prd-template.md`
3. Execute: Build the thing in `3-Work/1-Initiative-Codename/`
