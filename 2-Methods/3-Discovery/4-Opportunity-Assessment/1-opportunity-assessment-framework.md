...
1. Use discovery frameworks in this domain (e.g., `../1-Research-Interviews/`, `../2-Continuous-Discovery-Habits/`) to validate assumptions
2. Store research artifacts in `4-Research/`
