...
- `2-jtbd-template.md` — Job file template for individual jobs (copy into `4-Research/jobs/`)
...
**Use the prompts:** [`../../../system/coaching/prompts.md`](../../../system/coaching/prompts.md)
