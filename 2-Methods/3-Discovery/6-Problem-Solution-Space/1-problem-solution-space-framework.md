...
**Use prompts from:** [system/coaching/prompts.md](../../../system/coaching/prompts.md) → [Generic Step 0](../../../system/coaching/prompts.md#generic-step-0-any-framework) and [Before User Research / Discovery](../../../system/coaching/prompts.md#before-user-research--discovery). Quick start: What problem are you trying to solve → What feels like the real problem → What assumptions → If you had to explain this problem to a 5-year-old, what would you say → **See prompts file for full list.**
...
- Research Interviews: `../1-Research-Interviews/README.md`
- Continuous Discovery Habits: `../2-Continuous-Discovery-Habits/README.md`
- Jobs to Be Done: `../3-Jobs-To-Be-Done/README.md`
- Opportunity Assessment: `../4-Opportunity-Assessment/README.md`
- Execution: `../../4-Execution/README.md` (PRD Framework)
