...
- **1-Context/** → Strategic foundation and company context.
- **2-Methods/** → Frameworks and methods (this interview guide lives under `3-discovery/1-Research-Interviews/`).
- **4-Research/** → Archive for interview notes, synthesis docs, and research findings.
- **3-Work/** → Active initiatives and opportunity assessments that link to your research.

## Before Conducting Interviews: Braindump & Product Sense

**Use prompts from:** [prompts.md](../../../system/coaching/prompts.md) → [Before Continuous Discovery (interviews / synthesis / opportunities)](../../../system/coaching/prompts.md#before-continuous-discovery-interviews-synthesis-opportunities).
...
1. **Capture Insights Immediately**
   ...
   - Use your preferred interview notes template or the structure in `4-Research/1-User-Interviews/`
   - Note surprises, contradictions, and patterns

2. **Save Artifacts**
   - Save raw transcript PDFs to `1-User-Interviews/transcripts/`
   - Save AI-generated snapshot markdowns to `1-User-Interviews/snapshots/`
   - Add synthesis docs under `1-User-Interviews/synthesis/`
...
- Discovery methods: `2-Methods/3-Discovery/`  
- Research artifacts structure: `4-Research/`
